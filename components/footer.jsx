...
export default function Footer() { // Définition du composant Footer
  return (
    <footer className={styles.footer} role="contentinfo" aria-label="Informations du site"> 
      <div className={styles.container}> 
        <div className={styles.grid}> 
          
          {/* Section "À propos de Conex" */}
          <div className={styles.section}>
            <h3 id="about-heading">About Conex</h3>
          ...
          <div className={styles.section}>
            <h3 id="social-heading">Connect With Us</h3> 
            <div className={styles.social} role="group" aria-labelledby="social-heading"> 
              {/* Lien vers Twitter */}
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Visitez notre page Twitter">
              ...
              {/* Lien vers GitHub */}
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="Visitez notre page GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" focusable="false">
